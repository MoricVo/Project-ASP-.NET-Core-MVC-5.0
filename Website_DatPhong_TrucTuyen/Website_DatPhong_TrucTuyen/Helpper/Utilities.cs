...
namespace Website_DatPhong_TrucTuyen.Helpper
{
    public static  class Utilities
    {
        ...
        public static async Task<string> UploadFile(Microsoft.AspNetCore.Http.IFormFile file, string sDirectory, string newname = null)
        {
            try
            {
                ...
                string path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Image2", sDirectory);
                CreateIfMissing(path);
                string pathFile = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Image2", sDirectory, newname);
