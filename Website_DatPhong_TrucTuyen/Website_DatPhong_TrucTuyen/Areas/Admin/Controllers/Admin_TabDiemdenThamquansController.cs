...
{
    [Area("Admin")]
    public class Admin_TabDiemdenThamquansController : Controller
    {
        private readonly csdl_doan_congnghewebContext _context;

        public Admin_TabDiemdenThamquansController(csdl_doan_congnghewebContext context)
        {
            _context = context;
        }

        // GET: Admin/Admin_TabDiemdenThamquans
        ...
        // GET: Admin/Admin_TabDiemdenThamquans/Details/5
        ...
        // GET: Admin/Admin_TabDiemdenThamquans/Create
        ...
        // POST: Admin/Admin_TabDiemdenThamquans/Create
        ...
        // GET: Admin/Admin_TabDiemdenThamquans/Edit/5
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["IdDiemden"] = new SelectList(_context.TabDiadiems, "IdDiadiem", "Tendiadiem", tabDiemdenThamquan.IdDiemden);
            ViewData["IdNguoidung"] = new SelectList(_context.TabNguoidungs, "IdNguoidung", "Tennguoidung", tabDiemdenThamquan.IdNguoidung);
            return View(tabDiemdenThamquan);
        }

        // POST: Admin/Admin_TabDiemdenThamquans/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(IFormFile file,int id, [Bind("IdDiemdenThamquan,IdNguoidung,IdDiemden,Diachicuthe,Slngayo,Tendiadiemthamquan,Tienich,Tienich1,Tienich2,Tienich3,Tienich4,Giatien,Hinhanh,Hinhphu1,Hinhphu2,Hinhphu3,Hinhphu4,Noiquy1,Noiquy2,Noiquy3,Noiquy4,Noiquy5,Ngaydatphong,Ngaytraphong,Ngaydang,Ngaycapnhat")] TabDiemdenThamquan tabDiemdenThamquan)
        {
        ...
        // GET: Admin/Admin_TabDiemdenThamquans/Delete/5
        ...
        // POST: Admin/Admin_TabDiemdenThamquans/Delete/5
